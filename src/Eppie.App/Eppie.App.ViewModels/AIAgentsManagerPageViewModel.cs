...
namespace Tuvi.App.ViewModels
{
    public class AIAgentsManagerPageViewModel : BaseViewModel
    {
        ...
        public ICommand CreateAIAgentCommand => new RelayCommand(() => NavigationService?.NavigateToLocalAIAgentSettings());
        ...
        private void EditAIAgentInfo(object item)
        {
            ...
            {
                NavigationService?.NavigateToLocalAIAgentSettings(agent);
            }
        }
    }
}
